...
// CMAKE_MSVC_DEBUG_INFORMATION_FORMAT generates a PDB for every
// configuration (including Release), so this always resolves.
...
int main()
{
    ...
    // ULONG passed to CaptureStackBackTrace) into a small value that would
